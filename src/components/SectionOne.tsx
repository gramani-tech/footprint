...
export default function SectionOne() {
  return (
    <div className=' px-[3.5em] my-7'>
        <div className='text-center'>
            <h2 className=' font-serif text-[3.5rem] font-[600] leading-[1em]'> Lorem ipsum dolor <span className='block'>sit amet consectetur</span> </h2>
