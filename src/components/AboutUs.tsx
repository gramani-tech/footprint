    ...
    <div className="my-[2.5em] w-[100%] mx-auto mt-[150px]">
      ...
      <div className="my-8 w-full gap-1 flex-col-reverse md:flex-row flex ">
        <div className=" bg-white lg:pl-7  md:w-[60%] h-fit p-3 rounded-lg shadow-md drop-shadow-md">
          <div className="flex justify-between">
            <h3 className=" text-[1.5rem] md:text-[1.7rem] font-bold  ">
              Welcome to Footprint Mentorship
            </h3>
          ...
          <p className="my-5 text-[1rem]">
            At Footprint Mentorship, we are dedicated to revolutionizing the job
            search experience for tech professionals across Africa. Founded with
            a vision to create an inclusive ecosystem where every job seeker can
            achieve their dream job quickly and efficiently, we provide a
            comprehensive and personalized approach to career mentorship.
          </p>
        </div>
      ...
      <div className="my-7 w-full md:flex gap-3">
        ...
        <div className=" bg-white  md:w-[60%] h-fit p-3 lg:pl-7 rounded-lg shadow-md drop-shadow-md">
          ...
          <p className="my-5 text-[1rem]">
            Footprint Mentorship is more than just a mentorship platform; we are
            the bridge between ambition and achievement. Our team is composed of
            seasoned professionals with extensive experience in the tech
            industry and HR sector.
          </p>
        </div>
      </div>
      ...
      <div className=" font-platypi   lg:my-[200px]">
        <div className="w-fit mx-auto my-5">
          <h2 className="text-[2rem] md:text-[2.5rem] lg:text-[3rem] font-[600] relative">
            Our Services
            <img
              src={line2}
              alt="line-image"
        ...
        <div className=" mx-auto">
          <div className="flex flex-wrap justify-center gap-3 md:gap-5 lg:px-10">
            <div className=" w-fit bg-yellow  my-3 p-2 px-6 rounded-t-2xl rounded-bl-2xl flex gap-2 items-center">
              <h3 className="text-[1.2rem] sm:text-[1.5rem] font-bold">
                Personalise mentorship
              </h3>
              <div className="bg-black w-[20px] h-[20px] rounded-full">
                <img
                  src={upicon}
                  className="w-[12px] m-1"
                  alt="up-right-icon"
                />
              </div>
            </div>
          ...
          <div className="bg-[#54E3EA] w-fit mx-auto  my-3 p-2 rounded-t-2xl rounded-br-2xl flex gap-2 items-center">
            <h3 className="text-[1.2rem] sm:text-[1.5rem] font-bold  px-6">
