...
export default function Section3() {
  return (
    <div className=' px-[3.5em] w-[90%] mx-auto '>
        <div className='w-full mt-[5em] mb-[5em]'>
            <div className=' w-fit my-5'>
                <h2 className=' text-[3rem] font-serif font-[600] relative'>FAQS
                    <img src={line1} alt='line-image' className=' absolute -bottom-1 -z-10'/>
                </h2>
            </div>

            <div className=' w-[70%] my-10 ml-auto  '>
        ...
        <div>
            ...
            <div className='w-fit  my-5'>
                <h2 className=' text-[3rem] font-serif font-[600] relative'>Testimonials
                    <img src={line2} alt='line-image' className=' absolute -bottom-1 -z-10'/>
                </h2>
            </div>

            <div className='p-1 relative grid grid-cols-2 gap-5 bg-gradient-to-t from-purple to-[#FAF7F5] rounded-xl py-[3em]'>
                ...
                <div className=' bg-white flex absolute left-[40%] cursor-pointer bottom-[15%] rounded-2xl items-center gap-2 px-3 py-1'>
