    ...
    <div className=' w-[100%] my-[3em] mx-auto '>
        <div className='w-full mt-[2em] mb-[5em]'>
            ...
            <div className='w-[90%] text-[1rem] md:w-[70%] my-10 ml-auto  '>
                ...
                <p className=''>Lorem ipsum dolor sit amet consectetur. Nisl volutpat nec in lorem. Ipsum turpis quam mauris quis a bibendum aliquam. Nisi euismod ullamcorper adipiscing ullamcorper odio vel. Ornare sit diam enim commodo. Facilisis odio nibh enim in sed ullamcorper.</p>
                </div>
